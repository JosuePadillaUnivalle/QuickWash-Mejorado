...
@section('content')
<h2>Tu próximo lavado, sin filas.</h2><p class="muted">Crea tu cuenta con tu correo institucional <strong>@est.univalle.edu</strong> para empezar a reservar.</p>
...
<label>Correo institucional<input type="email" name="email" value="{{ old('email') }}" maxlength="200" placeholder="tu.nombre@est.univalle.edu" required autocomplete="email"></label>
